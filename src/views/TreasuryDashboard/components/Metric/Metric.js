...
export const CurrentIndex = () => {
  ...
  return (
    <Metric className="index">
      <Metric.Title>
        Current Index
        <InfoTooltip message="The current index tracks the amount of sWEN accumulated since the beginning of staking. Basically, how much sWEN one would have if they staked and held a single WEN from day 1." />
      </Metric.Title>
