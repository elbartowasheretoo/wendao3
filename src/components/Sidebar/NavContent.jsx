...
import WagmiWenLogo from "../../assets/images/logo-wide.png";
        ...
        <div className="dapp-menu-top">
          <Box className="branding-header">
            <Link href="https://exodia.fi" target="_blank">
              <img src={WagmiWenLogo} alt={"WagmiWen logo"} width="200px" />
            </Link>
          ...
          <div className="dapp-menu-links">
            <div className="dapp-nav" id="navbarNav">
              ...
              >
                <Tooltip
                  title={<Trans>Estimate and visualize your potential returns over time by staking with WagmiWen</Trans>}
                >
