...
var GA4 = /*#__PURE__*/function () {
  function GA4() {
    ...
    _defineProperty(this, "reset", function () {
      ...
      _this._current_GA_MEASUREMENT_ID;
    ...
    _defineProperty(this, "_loadGA", function (GA_MEASUREMENT_ID) {
    ...
    _defineProperty(this, "initialize", function (GA_MEASUREMENT_ID) {
      ...
      _this._current_GA_MEASUREMENT_ID = GA_MEASUREMENT_ID;
      var _options$testMode = options.testMode,
          testMode = _options$testMode === void 0 ? false : _options$testMode,
          gaOptions = options.gaOptions,
          gtagOptions = options.gtagOptions;
      _this._testMode = testMode;

      var mergedGtagOptions = _this._appendCustomMap(_objectSpread(_objectSpread({
        // https://developers.google.com/analytics/devguides/collection/gtagjs/pages#disable_pageview_measurement
        send_page_view: false
      }, _this._toGtagOptions(gaOptions)), gtagOptions));

      if (!testMode) {
        _this._loadGA(_this._current_GA_MEASUREMENT_ID, mergedGtagOptions);
      }

      if (!_this.isInitialized) {
        _this._gtag("js", new Date());

        _this._gtag("config", _this._current_GA_MEASUREMENT_ID, mergedGtagOptions);
      }
    ...
    _defineProperty(this, "set", function (fieldsObject) {
      ...
      return _this._gaCommand("set", fieldsObject);
    });
    ...
    _defineProperty(this, "ga", function () {
      ...
      if (typeof args[0] === "string") {
        ...
        _this._gtag("get", _this._current_GA_MEASUREMENT_ID, "client_id", function (clientId) {
          _this._isQueuing = false;
          var queues = _this._queueGtag;
          readyCallback({
            get: function get(property) {
              return property === "clientId" ? clientId : property === "trackingId" ? _this._current_GA_MEASUREMENT_ID : property === "apiVersion" ? "1" : undefined;
            }
          });
    ...
    _defineProperty(this, "event", function () {
      var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          args = _objectWithoutProperties(_ref3, _excluded4);
    ...
    _defineProperty(this, "send", function (fieldObject) {
      return _this._gaCommand("send", fieldObject);
    });
